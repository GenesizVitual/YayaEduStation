...
@section('content')
    <div class="row">
        <!-- Notifikasi -->
        <div class="col-md-12">
            @include('user.tutor.include.notifikasi')
        </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <button class="btn btn-default">
                                        <img class="img-circle" @if(!empty($profile->linkToProfileUser)) src="{{ asset('user/tutor/photo/'.$profile->linkToProfileUser->foto) }}"
                                             @else
                                                src="https://raysensenbach.com/wp-content/uploads/2013/04/default.jpg"
                                             @endif
                                ...
                                <div class="col-md-9">
                                    <div class="row">
                                        ...
                                        <dd class="col-sm-8">@if(!empty($profile->linkToProfileUser)){{$profile->linkToProfileUser->nama}} @endif</dd>
                                        <dt class="col-sm-4">Email</dt>
                                        <dd class="col-sm-8">@if(!empty($profile->linkToProfileUser)){{$profile->email}} @endif</dd>
                                        <dt class="col-sm-4">Nik</dt>
                                        <dd class="col-sm-8">@if(!empty($profile->linkToProfileUser)){{$profile->linkToProfileUser->kode}} @endif</dd>
                                        <dt class="col-sm-4">Tempat, Tanggal Lahir</dt>
                                        <dd class="col-sm-8">@if(!empty($profile->linkToProfileUser)){{$profile->linkToProfileUser->tempat_lahir.','}} {{ $profile->linkToProfileUser->tgl_lahir }} @endif </dd>
                                        <dt class="col-sm-4">Alamat</dt>
                                        <dd class="col-sm-8">@if(!empty($profile->linkToProfileUser)){{$profile->linkToProfileUser->alamat}} @endif</dd>
                                        <dt class="col-sm-4">No. Telepon</dt>
                                        <dd class="col-sm-8">@if(!empty($profile->linkToProfileUser)){{$profile->linkToProfileUser->no_telp}} @endif</dd>
                                        <dt class="col-sm-12">
                                            <hr>
                                        </dt>
                                        <dt class="col-sm-4">Pendidikan Terkahir</dt>
                                        <dd class="col-sm-8">@if(!empty($profile->linkToProfileUser)){{$profile->linkToProfileUser->jenjang_pendidikan.' '.$profile->linkToProfileUser->pt}}  @endif</dd>
                        ...
                        <div class="card-footer">
                            <a href="{{ url('profile-tutor') }}" class="float-right">ubah profile</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
